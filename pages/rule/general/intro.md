...
### Modifiers to Checks
Making a check is not always straight forward, heavy rain or a well-made sword can change the outcome of an attack. These modifiers come in two varieties. Factors apply a straight bonus or penalty to one of your values. Advantage and Disadvantage change the way that the roll itself works, applying a more or less favorable outcome randomly.

When a power or feature has you halve a bonus or penalty for a certain thing, like halve Defensive Roll penalty to the Narrow Space state, you halve the factors and halve the Advantage or Disadvantage, round up.

#### Factors
When a situation is outright easier or harder is represented by a factor, split into bonus and penalty. As you will find in later sections, there are many kinds but not all of them are created equally. Below is a list of common factors you will encounter and how they combine or stack with the same kind.

Characteristic Modifier: Characteristic Modifiers are derived from your Final Characteristic Value. They represent your natural talent for something, for example a person with a high intellectual ability will be better at learning and recalling knowledge.

**Innate**: Innate bonuses are ones gained every level, or several levels. All sources of innate bonuses stack and are considered part of your Final Value. In some cases, innate bonuses do not increase with your level, martial arts grant a one time bonus and your Potential's innate bonus is increased by investing Phenom Points.

**Natural**: Natural factors usually come from features, meaning they are permanent. All natural factors stack and are considered part of your Final Value. 

**All-action**: An all-action factors are special, they apply to all Skill Checks that you make. When you are subject to multiple all-action factors, each one applies to the roll.

**Deed**: Deed factors come from states, maneuvers, and other environmental factors. All deed factors stack and are added to your Final Roll.

**Quality**: Quality factors come of well-made or poorly made objects. Quality factors do not stack and you will rarely apply more than one to a roll, if you do, apply the highest bonus and the lowest penalty. This factor is added to your Final Roll.

**Power**: Power factors come from powers and are temporary and are added to the Final Roll, not to the Final Value. You take the highest power bonus and the lowest power penalty.

#### Advantage and Disadvantage
Some situations have a more or less favorable outcome than normal, either due to environmental conditions or supernatural forces. In these circumstances, your roll is modified to be with Advantage or Disadvantage. Advantage means that when you roll a Skill Check or Resistance Check, roll an additional d6 and take the highest two rolls as your final roll. Disadvantage is you take the lowest two rolls as your Base Roll.
...
{% include example.html content="For example, Ceil making an Attack against a bandit, she has one degree of Advantage (A2) from having the Higher Ground State over her opponent but is granted three levels of Disadvantage (D3) as a result of an opponent's power. When she rolls for her Strike Skill, she ends up having one degree of Disadvantage (2 - 3 = 1). So she rolls three d6s and takes the lowest two dice as the roll." %}

### Core Terminology
Below are a few terms that you will see throughout this system. They will help define how numbers interact.

**Base Value**: This number is your core value. Your Base Characteristic Value is your unmodified Characteristic. Base Skill Value is what you have gained by spending Experience Points. Base Resistance Value is equal to your Presence.

**Final Value**: This number if your Base Value along with some permanent factors. Your Final Characteristic Value is usually unchanged since there are no permanent factors that will modify it -- most changes are either power factors or a change to your Base Value. Final Skill Value and Final Resistance Value add the Characteristic Modifier (which is determined by your Final Characteristic Value), your natural factors, and any innate bonus. This Final Value is used to determine if you meet the requirements for certain abilities and is what is added to your Roll.

**Base Roll**: This number if your Final Value and the roll of a 2d6. There are no factors that modify this number. If you are subject to Advantage or Disadvantage, they can change your roll.

**Final Roll**: This is the sum of your Base Roll and any other factors. Deed and power factors are added here.
